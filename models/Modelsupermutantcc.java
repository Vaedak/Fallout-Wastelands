...
public static class Modelsupermutantcc extends ModelBase {
	...
	public Modelsupermutantcc() {
		...
		RightArm.cubeList.add(new ModelBox(RightArm, 0, 64, -1.0F, 14.0F, -27.0F, 2, 1, 33, 0.0F, false));
		RightArm.cubeList.add(new ModelBox(RightArm, 37, 88, -1.0F, 15.0F, -26.0F, 2, 2, 7, 0.0F, false));

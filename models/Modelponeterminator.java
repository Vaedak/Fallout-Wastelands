...
public static class Modelponeterminator extends EntityModel<Entity> {
	...
	public Modelponeterminator() {
		...
		bone.setRotationPoint(1.0F, 9.9319F, -2.5176F);
		LeftArm.addChild(bone);
		setRotationAngle(bone, -0.2618F, 0.0F, 0.0F);
		bone.setTextureOffset(0, 66).addBox(-1.0F, -1.5314F, -1.0365F, 2.0F, 8.0F, 3.0F, 0.0F, false);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(0.0F, 2.0F, 2.0F);
		bone.addChild(bone2);
		setRotationAngle(bone2, 0.0F, -0.8727F, 0.0F);
		bone2.setTextureOffset(0, 0).addBox(-1.0F, 4.0F, -1.0F, 1.0F, 7.0F, 1.0F, 0.0F, false);
		bone2.setTextureOffset(18, 86).addBox(-1.8893F, 3.0F, -2.0516F, 1.0F, 5.0F, 1.0F, 0.0F, false);

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(1.0F, 0.0F, 0.0F);
		bone.addChild(bone3);
		setRotationAngle(bone3, -0.2618F, 0.0F, 0.0F);
		bone3.setTextureOffset(0, 78).addBox(-2.0F, 0.0F, 2.0F, 2.0F, 3.0F, 3.0F, 0.0F, false);

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, 0.0F, 0.0F);
		bone3.addChild(bone4);
		setRotationAngle(bone4, -0.5672F, 0.0F, 0.0F);
		bone4.setTextureOffset(0, 97).addBox(-2.0F, -2.6865F, 4.217F, 2.0F, 3.0F, 3.0F, 0.0F, false);

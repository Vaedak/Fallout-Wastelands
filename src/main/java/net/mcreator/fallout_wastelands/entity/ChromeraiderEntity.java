...
public class ChromeraiderEntity extends Monster {
	public ChromeraiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FalloutWastelandsModEntities.CHROMERAIDER.get(), world);
	}

	public ChromeraiderEntity(EntityType<ChromeraiderEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(FalloutWastelandsModItems.TIREIRON.get()));
	}

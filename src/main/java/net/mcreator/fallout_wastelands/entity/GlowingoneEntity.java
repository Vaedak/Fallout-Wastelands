...
import net.mcreator.fallout_wastelands.procedures.GlowingonePlayerCollidesWithThisEntityProcedure;
import net.mcreator.fallout_wastelands.particle.RadiationparticlesParticle;
...
public class GlowingoneEntity extends FalloutWastelandsModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8144290, -4073093, new Item.Properties().group(ItemGroup.MISC))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("fallout_wastelands:theglow").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(NuclearwasteItem.block));
		}
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.fungus.step")), 0.15f,
					1);
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			GlowingonePlayerCollidesWithThisEntityProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(RadiationparticlesParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}

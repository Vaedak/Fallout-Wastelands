...
public class RangedsupermutantRenderer {
	...
	public static class Modelsupermutantranger extends EntityModel<Entity> {
		...
		public Modelsupermutantranger() {
			...
			addBoxHelper(Head, 0, 57, -1.0F, -6.0F, -5.0F, 2, 6, 7, 0.0F, false);
			addBoxHelper(Head, 0, 71, -4.0F, 1.0F, 4.0F, 8, 1, 2, 0.0F, false);
			...
			Body.addChild(bone);
			addBoxHelper(bone, 57, 1, -8.0F, -1.0F, -7.0F, 2, 4, 13, 0.0F, false);
			bone2 = new ModelRenderer(this);
			bone2.setRotationPoint(0.0F, 0.0F, 0.0F);
			setRotationAngle(bone2, 0.0F, 0.0F, -0.6981F);
			bone.addChild(bone2);
			addBoxHelper(bone2, 57, 19, -6.1F, -5.0F, -21.0F, 1, 1, 14, 0.0F, false);
			RightArm = new ModelRenderer(this);
			RightArm.setRotationPoint(-8.0F, -7.0F, -1.0F);
			setRotationAngle(RightArm, -0.4363F, 0.0F, 0.1745F);
			addBoxHelper(RightArm, 40, 0, -2.0F, 4.0F, -2.0F, 4, 11, 4, 0.0F, false);
			addBoxHelper(RightArm, 52, 52, -2.5F, -3.0F, -2.25F, 4, 7, 4, 0.0F, false);
			LeftArm = new ModelRenderer(this);
			LeftArm.setRotationPoint(8.0F, -7.0F, -1.0F);
			setRotationAngle(LeftArm, -1.0472F, 0.9599F, 0.0F);
			addBoxHelper(LeftArm, 40, 40, -2.0F, 7.0F, -2.0F, 4, 11, 4, 0.0F, false);
			addBoxHelper(LeftArm, 36, 15, -2.0F, 0.0F, -2.25F, 4, 7, 4, 0.0F, false);

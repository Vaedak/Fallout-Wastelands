...
import net.mcreator.fallout_wastelands.entity.EnclaveMachinegunTurretEntity;
...
@OnlyIn(Dist.CLIENT)
public class EnclaveMachinegunTurretRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EnclaveMachinegunTurretEntity.entity, renderManager -> {

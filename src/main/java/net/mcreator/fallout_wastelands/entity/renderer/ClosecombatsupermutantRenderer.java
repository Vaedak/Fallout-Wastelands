...
@OnlyIn(Dist.CLIENT)
public class ClosecombatsupermutantRenderer {
	...
	public static class Modelsupermutantcc extends EntityModel<Entity> {
		...
		public Modelsupermutantcc() {
			...
			addBoxHelper(RightArm, 0, 64, -1.0F, 14.0F, -27.0F, 2, 1, 33, 0.0F, false);
			addBoxHelper(RightArm, 37, 88, -1.0F, 15.0F, -26.0F, 2, 2, 7, 0.0F, false);

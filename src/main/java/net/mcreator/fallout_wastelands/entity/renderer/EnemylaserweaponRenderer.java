...
@OnlyIn(Dist.CLIENT)
public class EnemylaserweaponRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EnemylaserweaponItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<EnemylaserweaponItem.ArrowCustomEntity> {
		...
		@Override
		public void render(EnemylaserweaponItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(EnemylaserweaponItem.ArrowCustomEntity entity) {
			return texture;
		}
	}

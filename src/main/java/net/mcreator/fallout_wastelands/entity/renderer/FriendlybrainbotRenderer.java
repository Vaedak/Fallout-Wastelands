...
public class FriendlybrainbotRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FriendlybrainbotEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelarmyrobobrain(), 1.5f) {

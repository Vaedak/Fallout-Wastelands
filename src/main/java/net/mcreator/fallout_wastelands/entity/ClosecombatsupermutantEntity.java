...
public class ClosecombatsupermutantEntity extends Monster {
	public ClosecombatsupermutantEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FalloutWastelandsModEntities.CLOSECOMBATSUPERMUTANT.get(), world);
	}

	public ClosecombatsupermutantEntity(EntityType<ClosecombatsupermutantEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(26, new NearestAttackableTargetGoal(this, BrotherhoodPaladinEntity.class, true, false));

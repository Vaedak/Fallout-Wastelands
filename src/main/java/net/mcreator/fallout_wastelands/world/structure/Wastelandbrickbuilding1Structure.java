...
public class Wastelandbrickbuilding1Structure extends FalloutWastelandsModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public Wastelandbrickbuilding1Structure(FalloutWastelandsModElements instance) {
		super(instance, 276);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 2000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("fallout_wastelands", "brickbigbuilding1"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("wastelandbrickbuilding_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fallout_wastelands:wastelandbrickbuilding_1"),
					configuredFeature);
		}
	}
	@SubscribeEvent

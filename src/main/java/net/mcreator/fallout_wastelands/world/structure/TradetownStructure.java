...
public class TradetownStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 800) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("fallout_wastelands", "structurebase"));
							if (template == null)
								return false;
							...
							TradetownOnStructureInstanceGeneratedProcedure.executeProcedure(Stream
			...
			event.getRegistry().register(feature.setRegistryName("tradetown"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fallout_wastelands:tradetown"), configuredFeature);
		}
	}

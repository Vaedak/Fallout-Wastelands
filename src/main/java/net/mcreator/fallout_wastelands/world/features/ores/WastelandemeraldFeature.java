...
public class WastelandemeraldFeature extends OreFeature {
	public static WastelandemeraldFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandemeraldFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandemerald", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDEMERALD.get().defaultBlockState())),
						1));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandemerald", CONFIGURED_FEATURE,
	...
	public WastelandemeraldFeature() {

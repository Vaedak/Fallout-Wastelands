...
public class WastelandgoldFeature extends OreFeature {
	public static WastelandgoldFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandgoldFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandgold", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDGOLD.get().defaultBlockState())),
						6));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandgold", CONFIGURED_FEATURE,

...
public class WastelandgravelFeature extends OreFeature {
	public static WastelandgravelFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandgravelFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandgravel", FEATURE,
				new OreConfiguration(
						...
						30));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandgravel", CONFIGURED_FEATURE,

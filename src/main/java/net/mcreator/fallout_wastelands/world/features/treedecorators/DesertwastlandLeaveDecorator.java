...
public class DesertwastlandLeaveDecorator extends LeaveVineDecorator {
	public static final DesertwastlandLeaveDecorator INSTANCE = new DesertwastlandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("desertwastland_tree_leave_decorator", tdt);
	}

	public DesertwastlandLeaveDecorator() {
		super(0.25f);
	}

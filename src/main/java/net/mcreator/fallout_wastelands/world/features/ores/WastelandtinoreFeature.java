...
public class WastelandtinoreFeature extends OreFeature {
	public static WastelandtinoreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandtinoreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandtinore", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDTINORE.get().defaultBlockState())),
						15));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandtinore", CONFIGURED_FEATURE,

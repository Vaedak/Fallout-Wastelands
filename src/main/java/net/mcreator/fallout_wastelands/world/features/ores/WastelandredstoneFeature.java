...
public class WastelandredstoneFeature extends OreFeature {
	public static WastelandredstoneFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandredstoneFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandredstone", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDREDSTONE.get().defaultBlockState())),
						5));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandredstone", CONFIGURED_FEATURE,
	...
	public WastelandredstoneFeature() {

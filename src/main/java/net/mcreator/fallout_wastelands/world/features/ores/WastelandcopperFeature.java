...
public class WastelandcopperFeature extends OreFeature {
	public static WastelandcopperFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandcopperFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandcopper", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDCOPPER.get().defaultBlockState())),
						10));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandcopper", CONFIGURED_FEATURE,

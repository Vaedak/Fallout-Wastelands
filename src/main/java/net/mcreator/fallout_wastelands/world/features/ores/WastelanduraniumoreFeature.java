...
public class WastelanduraniumoreFeature extends OreFeature {
	public static WastelanduraniumoreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelanduraniumoreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelanduraniumore", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDURANIUMORE.get().defaultBlockState())),
						2));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelanduraniumore", CONFIGURED_FEATURE,
	...
	public WastelanduraniumoreFeature() {

...
public class WastelandironFeature extends OreFeature {
	public static WastelandironFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandironFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandiron", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDIRON.get().defaultBlockState())),
						8));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandiron", CONFIGURED_FEATURE,

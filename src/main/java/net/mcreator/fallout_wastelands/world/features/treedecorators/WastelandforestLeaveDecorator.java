...
public class WastelandforestLeaveDecorator extends LeaveVineDecorator {
	public static final WastelandforestLeaveDecorator INSTANCE = new WastelandforestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("wastelandforest_tree_leave_decorator", tdt);
	}

	public WastelandforestLeaveDecorator() {
		super(0.25f);
	}

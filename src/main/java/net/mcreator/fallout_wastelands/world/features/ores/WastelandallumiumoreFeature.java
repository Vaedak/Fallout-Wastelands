...
public class WastelandallumiumoreFeature extends OreFeature {
	public static WastelandallumiumoreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelandallumiumoreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelandallumiumore", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDALLUMIUMORE.get().defaultBlockState())),
						7));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelandallumiumore", CONFIGURED_FEATURE,
	...
	public WastelandallumiumoreFeature() {

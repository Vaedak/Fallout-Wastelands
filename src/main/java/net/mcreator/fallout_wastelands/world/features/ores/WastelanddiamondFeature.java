...
public class WastelanddiamondFeature extends OreFeature {
	public static WastelanddiamondFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WastelanddiamondFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("fallout_wastelands:wastelanddiamond", FEATURE,
				new OreConfiguration(
						List.of(OreConfiguration.target(new BlockStateMatchTest(FalloutWastelandsModBlocks.WASTLANDSTONE.get().defaultBlockState()),
								FalloutWastelandsModBlocks.WASTELANDDIAMOND.get().defaultBlockState())),
						5));
		PLACED_FEATURE = PlacementUtils.register("fallout_wastelands:wastelanddiamond", CONFIGURED_FEATURE,
	...
	public WastelanddiamondFeature() {

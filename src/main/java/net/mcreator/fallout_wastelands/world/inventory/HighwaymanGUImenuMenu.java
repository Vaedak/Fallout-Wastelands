...
public class HighwaymanGUImenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HighwaymanGUImenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.HIGHWAYMAN_GU_IMENU.get(), id);

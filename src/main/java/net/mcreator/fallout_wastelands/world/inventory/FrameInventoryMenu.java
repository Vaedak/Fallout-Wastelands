...
public class FrameInventoryMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FrameInventoryMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.FRAME_INVENTORY.get(), id);
	...
	public void removed(Player playerIn) {
		...
		FrameInventoryThisGUIIsClosedProcedure.execute(world, x, y, z, entity);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FrameInventoryMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			FrameInventoryWhileThisGUIIsOpenTickProcedure.execute(world, x, y, z, entity);
		}
	}
}

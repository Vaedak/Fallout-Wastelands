...
public class AmmunitionboxguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AmmunitionboxguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.AMMUNITIONBOXGUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 12) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (FalloutWastelandsModItems.SEPTAMMO.get() == stack.getItem());
			}
		}));
		...
		this.customSlots.put(9, this.addSlot(new SlotItemHandler(internal, 9, 7, 30) {
			@Override
			public boolean mayPlace(ItemStack stack) {
				return (FalloutWastelandsModItems.FUSIONMICROCELL.get() == stack.getItem());
			}
		}));

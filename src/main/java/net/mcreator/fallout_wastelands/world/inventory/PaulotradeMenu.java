...
import net.mcreator.fallout_wastelands.procedures.PaulowatchingfortradesProcedure;
import net.mcreator.fallout_wastelands.network.PaulotradeSlotMessage;
...
public class PaulotradeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PaulotradeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.PAULOTRADE.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, -10, 8) {
			...
			public boolean mayPlace(ItemStack stack) {
				return (FalloutWastelandsModItems.BOTTLECAPS.get() == stack.getItem());
			}
		}));
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			FalloutWastelandsMod.PACKET_HANDLER.sendToServer(new PaulotradeSlotMessage(slotid, x, y, z, ctype, meta));
			PaulotradeSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof PaulotradeMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			PaulowatchingfortradesProcedure.execute(entity);
		}
	}
}

...
public class WastelandconcretewallBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:wastelandconcretewall")
	public static final Block block = null;
	public WastelandconcretewallBlock(FalloutWastelandsModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wastelandconcretewall");
		}

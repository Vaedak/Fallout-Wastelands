...
public class RustedironwallsBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:rustedironwalls")
	public static final Block block = null;
	public RustedironwallsBlock(FalloutWastelandsModElements instance) {
		super(instance, 153);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("rustedironwalls");
		}

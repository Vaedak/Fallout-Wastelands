...
public class SheetmetalwallBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:sheetmetalwall")
	public static final Block block = null;
	public SheetmetalwallBlock(FalloutWastelandsModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("sheetmetalwall");
		}

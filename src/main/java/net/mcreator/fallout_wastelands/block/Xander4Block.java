...
public class Xander4Block extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:xander_4")
	public static final Block block = null;
	public Xander4Block(FalloutWastelandsModElements instance) {
		super(instance, 560);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				Xander4UpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}

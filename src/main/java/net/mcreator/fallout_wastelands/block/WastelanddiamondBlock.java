...
public class WastelanddiamondBlock extends FalloutWastelandsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wastelanddiamond");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fallout_wastelands:wastelanddiamond_match"),
			...
			event.getRegistry().register(feature.setRegistryName("wastelanddiamond"));

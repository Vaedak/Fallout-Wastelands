...
public class FridgeBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public FridgeBlockEntity(BlockPos position, BlockState state) {
		super(FalloutWastelandsModBlockEntities.FRIDGE.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new LockeropMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

...
public class MojaveyuccaBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:mojaveyucca")
	public static final Block block = null;

	public MojaveyuccaBlock(FalloutWastelandsModElements instance) {
		super(instance, 1420);
	...
	public void initElements() {
		...
		elements.items.add(() -> new TallBlockItem(block, new Item.Properties().group(BlocsWItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("mojaveyucca"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fallout_wastelands:mojaveyucca"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.WOOD).hardnessAndResistance(1f, 1f)
					.setLightLevel(s -> 0));
			setRegistryName("mojaveyucca");
		}

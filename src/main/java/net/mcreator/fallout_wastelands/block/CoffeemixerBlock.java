...
import net.mcreator.fallout_wastelands.procedures.CoffeemixerOnBlockRightClickedProcedure;
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(9f, 15f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().slipperiness(0.7999999999999999f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("coffeemixer");
		}

...
public class MilitaryplatingwallBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:militaryplatingwall")
	public static final Block block = null;
	public MilitaryplatingwallBlock(FalloutWastelandsModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("militaryplatingwall");
		}

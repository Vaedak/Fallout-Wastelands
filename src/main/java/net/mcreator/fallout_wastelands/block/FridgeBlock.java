...
import net.mcreator.fallout_wastelands.gui.LockeropGui;
...
public class FridgeBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:fridge")
	public static final Block block = null;
	@ObjectHolder("fallout_wastelands:fridge")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FridgeBlock(FalloutWastelandsModElements instance) {
		super(instance, 618);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fridge"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Fridge");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new LockeropGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new LockeropGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}

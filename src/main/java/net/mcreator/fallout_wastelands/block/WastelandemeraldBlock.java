...
public class WastelandemeraldBlock extends FalloutWastelandsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wastelandemerald");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fallout_wastelands:wastelandemerald_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 1)).range(12)
					.square().func_242731_b(1);
			event.getRegistry().register(feature.setRegistryName("wastelandemerald"));

...
public class WastelancobblestonewallBlock extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:wastelancobblestonewall")
	public static final Block block = null;
	public WastelancobblestonewallBlock(FalloutWastelandsModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("wastelancobblestonewall");
		}

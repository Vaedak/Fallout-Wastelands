...
public class AluminiumingotItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:aluminiumingot")
	public static final Item block = null;
	public AluminiumingotItem(FalloutWastelandsModElements instance) {
		super(instance, 335);
	}

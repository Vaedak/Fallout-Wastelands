...
public class AluminiumnuggetItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:aluminiumnugget")
	public static final Item block = null;
	public AluminiumnuggetItem(FalloutWastelandsModElements instance) {
		super(instance, 424);
	}

...
public class MmpistolnineaimItem extends Item {
	public MmpistolnineaimItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MmpistolnineaimEntity entityarrow = MmpistolnineaimEntity.shoot(world, entity, world.getRandom(), 5f, 1, 0);

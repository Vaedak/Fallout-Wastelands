...
public abstract class VaultjumpsuitItem extends ArmorItem {
	public VaultjumpsuitItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Chestplate extends VaultjumpsuitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fallout_wastelands:textures/models/armor/vaultjumpb__layer_1.png";
		}
	}

	public static class Leggings extends VaultjumpsuitItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fallout_wastelands:textures/models/armor/vaultjumpb__layer_2.png";
		}
	}

	public static class Boots extends VaultjumpsuitItem {
		public Boots() {

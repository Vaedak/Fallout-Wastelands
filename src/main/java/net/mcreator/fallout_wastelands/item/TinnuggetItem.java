...
public class TinnuggetItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:tinnugget")
	public static final Item block = null;
	public TinnuggetItem(FalloutWastelandsModElements instance) {
		super(instance, 425);
	}

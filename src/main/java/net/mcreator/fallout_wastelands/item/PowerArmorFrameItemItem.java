...
import net.mcreator.fallout_wastelands.procedures.PowerArmorFrameItemRightclickedOnBlockProcedure;
...
public class PowerArmorFrameItemItem extends FalloutWastelandsModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			PowerArmorFrameItemRightclickedOnBlockProcedure.executeProcedure(Stream

...
public class SteelingotItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:steelingot")
	public static final Item block = null;

	public SteelingotItem(FalloutWastelandsModElements instance) {
		super(instance, 344);
	}

...
public class RealTurretProjectileItem extends Item {
	public RealTurretProjectileItem() {
...
<<<<<<< HEAD
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				RealTurretProjectileEntity entityarrow = RealTurretProjectileEntity.shoot(world, entity, world.getRandom(), 4f, 1, 0);

...
public class CoppernuggetItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:coppernugget")
	public static final Item block = null;

	public CoppernuggetItem(FalloutWastelandsModElements instance) {
		super(instance, 422);
	}

...
public abstract class TaloncombatarmorItem extends ArmorItem {
	public TaloncombatarmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends TaloncombatarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fallout_wastelands:textures/models/armor/talonarmor__layer_1.png";
		}
	}
	...
	public static class Leggings extends TaloncombatarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fallout_wastelands:textures/models/armor/talonarmor__layer_2.png";
		}
	}

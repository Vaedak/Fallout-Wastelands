...
public class SteeldustItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:steeldust")
	public static final Item block = null;

	public SteeldustItem(FalloutWastelandsModElements instance) {
		super(instance, 380);
	}

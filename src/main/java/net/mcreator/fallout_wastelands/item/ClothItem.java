...
public class ClothItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:cloth")
	public static final Item block = null;

	public ClothItem(FalloutWastelandsModElements instance) {
		super(instance, 1661);
	}

...
public class LeadnuggetItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:leadnugget")
	public static final Item block = null;

	public LeadnuggetItem(FalloutWastelandsModElements instance) {
		super(instance, 423);
	}

...
public class LeadingotItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:leadingot")
	public static final Item block = null;
	public LeadingotItem(FalloutWastelandsModElements instance) {
		super(instance, 337);
	}

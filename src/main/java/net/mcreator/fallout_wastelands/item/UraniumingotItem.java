...
public class UraniumingotItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:uraniumingot")
	public static final Item block = null;

	public UraniumingotItem(FalloutWastelandsModElements instance) {
		super(instance, 438);
	}

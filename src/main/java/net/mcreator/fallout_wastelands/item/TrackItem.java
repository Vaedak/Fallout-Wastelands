...
public class TrackItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:track")
	public static final Item block = null;

	public TrackItem(FalloutWastelandsModElements instance) {
		super(instance, 248);
	}

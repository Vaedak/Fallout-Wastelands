...
public class IngotcopperItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:ingotcopper")
	public static final Item block = null;
	public IngotcopperItem(FalloutWastelandsModElements instance) {
		super(instance, 333);
	}

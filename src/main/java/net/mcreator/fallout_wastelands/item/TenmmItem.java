...
import net.mcreator.fallout_wastelands.entity.renderer.TenmmRenderer;
...
public class TenmmItem extends FalloutWastelandsModElements.ModElement {
	@ObjectHolder("fallout_wastelands:tenmm")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_tenmm").setRegistryName("projectile_tenmm");

	public TenmmItem(FalloutWastelandsModElements instance) {
		super(instance, 508);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TenmmRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(WastelanderscombattabItemGroup.tab).maxDamage(1200));
			setRegistryName("tenmm");
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fallout_wastelands:tenmmquieter")),

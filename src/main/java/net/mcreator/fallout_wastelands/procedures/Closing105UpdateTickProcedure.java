...
public class Closing105UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing105UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1265);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing105Block.block.getDefaultState().getBlock())) {
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Closing104Block.block.getDefaultState(), 3);
				try {

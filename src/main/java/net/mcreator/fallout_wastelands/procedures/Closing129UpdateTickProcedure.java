...
public class Closing129UpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == FalloutWastelandsModBlocks.CLOSING_129.get()) {
			if ((new Object() {
				...
				world.setBlock(new BlockPos(x, y, z), FalloutWastelandsModBlocks.CLOSING_128.get().defaultBlockState(), 3);
				{

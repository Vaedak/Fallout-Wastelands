...
public class Vaultanimation63UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Vaultanimation63UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 804);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency y for procedure Vaultanimation63UpdateTick!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Vaultanimation63Block.block.getDefaultState().getBlock())) {

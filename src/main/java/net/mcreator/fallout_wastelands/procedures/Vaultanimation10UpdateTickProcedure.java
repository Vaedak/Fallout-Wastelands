...
public class Vaultanimation10UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation10Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation11Block.block.getDefaultState(), 3);
		}
		try {

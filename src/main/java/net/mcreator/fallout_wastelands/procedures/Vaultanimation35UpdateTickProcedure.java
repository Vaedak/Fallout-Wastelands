...
public class Vaultanimation35UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation35Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation36Block.block.getDefaultState(), 3);
		}
		try {

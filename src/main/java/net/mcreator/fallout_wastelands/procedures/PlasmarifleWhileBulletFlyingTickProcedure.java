...
public class PlasmarifleWhileBulletFlyingTickProcedure extends FalloutWastelandsModElements.ModElement {
	public PlasmarifleWhileBulletFlyingTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 519);
	}

...
public class Vaultanimation20UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation20Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation21Block.block.getDefaultState(), 3);
		}
		try {

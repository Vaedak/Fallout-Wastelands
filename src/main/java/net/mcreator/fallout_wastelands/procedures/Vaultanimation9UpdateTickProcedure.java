...
public class Vaultanimation9UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation9Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation10Block.block.getDefaultState(), 3);
		}
		try {

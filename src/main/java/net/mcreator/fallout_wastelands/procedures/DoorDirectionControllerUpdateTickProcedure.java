...
public class DoorDirectionControllerUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z - 1))).getBlock() == VaultDoorBlock.block) == false) {
				world.setBlockState(new BlockPos(x, y, z), Blocks.AIR.getDefaultState(), 3);
			}
		}
		if ((new Object() {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x - 1, y, z))).getBlock() == VaultDoorBlock.block) == false) {
				world.setBlockState(new BlockPos(x, y, z), Blocks.AIR.getDefaultState(), 3);
			}
		}
		if ((new Object() {

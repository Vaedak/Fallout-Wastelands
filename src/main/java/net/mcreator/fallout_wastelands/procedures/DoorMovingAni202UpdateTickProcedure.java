...
public class DoorMovingAni202UpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == FalloutWastelandsModBlocks.DOOR_MOVING_ANI_202.get()) {
			...
			if ((new Object() {
				...
				world.setBlock(new BlockPos(x + 1, y, z), FalloutWastelandsModBlocks.DOOR_MOVING_ANI_203.get().defaultBlockState(), 3);
				{
			...
			if ((new Object() {
				...
				world.setBlock(new BlockPos(x, y, z - 1), FalloutWastelandsModBlocks.DOOR_MOVING_ANI_203.get().defaultBlockState(), 3);
				{

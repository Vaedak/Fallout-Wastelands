...
public class DoorMovingAni202UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public DoorMovingAni202UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1056);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency x for procedure DoorMovingAni202UpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency y for procedure DoorMovingAni202UpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency z for procedure DoorMovingAni202UpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency world for procedure DoorMovingAni202UpdateTick!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == DoorMovingAni202Block.block.getDefaultState().getBlock())) {
			new Object() {
				private int ticks = 0;
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) (x + 1), (int) y, (int) z), DoorMovingAni203Block.block.getDefaultState(), 3);
				try {
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)), DoorMovingAni203Block.block.getDefaultState(), 3);
				try {

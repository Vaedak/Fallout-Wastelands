...
public class DoorMovingAni202UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == DoorMovingAni202Block.block) {
			new Object() {
				private int ticks = 0;
			...
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x + 1, y, z), DoorMovingAni203Block.block.getDefaultState(), 3);
				try {
			...
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z - 1), DoorMovingAni203Block.block.getDefaultState(), 3);
				try {

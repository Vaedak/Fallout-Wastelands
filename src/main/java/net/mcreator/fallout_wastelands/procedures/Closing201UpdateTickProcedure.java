...
public class Closing201UpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z))).getBlock() == FalloutWastelandsModBlocks.CLOSING_201.get()) == true) {
				world.setBlock(new BlockPos(x, y, z), FalloutWastelandsModBlocks.CLOSING_200.get().defaultBlockState(), 3);
				{

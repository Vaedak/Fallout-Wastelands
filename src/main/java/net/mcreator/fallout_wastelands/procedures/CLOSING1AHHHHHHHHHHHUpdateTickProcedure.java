...
public class CLOSING1AHHHHHHHHHHHUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CLOSING1AHHHHHHHHHHHBlock.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), VaultDoorTopPartBlock.block.getDefaultState(), 3);
				try {

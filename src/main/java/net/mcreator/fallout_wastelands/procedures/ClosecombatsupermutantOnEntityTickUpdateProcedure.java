...
public class ClosecombatsupermutantOnEntityTickUpdateProcedure extends FalloutWastelandsModElements.ModElement {
	public ClosecombatsupermutantOnEntityTickUpdateProcedure(FalloutWastelandsModElements instance) {
		super(instance, 274);
	}

...
public class RangedsupermutantOnEntityTickUpdateProcedure extends FalloutWastelandsModElements.ModElement {
	public RangedsupermutantOnEntityTickUpdateProcedure(FalloutWastelandsModElements instance) {
		super(instance, 275);
	}

...
public class Vaultanimation5UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation5Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation6Block.block.getDefaultState(), 3);
		}
		try {

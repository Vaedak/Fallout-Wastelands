...
public class Vaultanimation108UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Vaultanimation108UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 888);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Vaultanimation108Block.block.getDefaultState()
				.getBlock())) {

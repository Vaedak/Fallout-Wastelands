...
public class Vaultanimation108UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation108Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation109Block.block.getDefaultState(), 3);
		}
		try {

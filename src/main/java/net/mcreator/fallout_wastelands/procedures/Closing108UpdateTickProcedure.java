...
public class Closing108UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing108Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), Closing107Block.block.getDefaultState(), 3);
				try {

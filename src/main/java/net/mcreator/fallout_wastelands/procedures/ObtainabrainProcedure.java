...
public class ObtainabrainProcedure extends FalloutWastelandsModElements.ModElement {
	public ObtainabrainProcedure(FalloutWastelandsModElements instance) {
		super(instance, 254);
		...
		if ((entity instanceof ChromeraiderEntity.CustomEntity)) {
			if ((Math.random() < 0.001)) {
				if (world instanceof World && !world.isRemote()) {
					ItemEntity entityToSpawn = new ItemEntity((World) world, x, y, z, new ItemStack(HumanbrainItem.block, (int) (1)));

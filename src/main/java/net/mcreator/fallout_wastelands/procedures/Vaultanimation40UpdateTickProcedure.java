...
public class Vaultanimation40UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation40Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation41Block.block.getDefaultState(), 3);
		}
		try {

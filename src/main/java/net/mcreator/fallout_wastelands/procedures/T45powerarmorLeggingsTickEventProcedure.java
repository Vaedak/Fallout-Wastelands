...
public class T45powerarmorLeggingsTickEventProcedure extends FalloutWastelandsModElements.ModElement {
	public T45powerarmorLeggingsTickEventProcedure(FalloutWastelandsModElements instance) {
		super(instance, 172);
	}

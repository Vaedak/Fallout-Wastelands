...
public class Vaultanimation25UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Vaultanimation25Block.block) {
			world.setBlockState(new BlockPos(x, y, z), Vaultanimation26Block.block.getDefaultState(), 3);
		}
		try {

...
public class T45powerarmorHelmetTickEventProcedure extends FalloutWastelandsModElements.ModElement {
	public T45powerarmorHelmetTickEventProcedure(FalloutWastelandsModElements instance) {
		super(instance, 171);
	}

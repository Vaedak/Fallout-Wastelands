...
public class Vaultanimation100UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Vaultanimation100UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 841);
	}

...
public class Closing117UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing117Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), Closing116Block.block.getDefaultState(), 3);
				try {

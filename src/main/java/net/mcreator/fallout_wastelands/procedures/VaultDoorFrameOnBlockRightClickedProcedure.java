...
public class VaultDoorFrameOnBlockRightClickedProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x + 3, y + 0, z + 1))).getBlock() == DoorMovingAni205Block.block) == true) {
				world.setBlockState(new BlockPos(x + 2, y, z + 1), Closing204Block.block.getDefaultState(), 3);
				try {
					BlockState _bs = world.getBlockState(new BlockPos(x + 2, y, z + 1));
					DirectionProperty _property = (DirectionProperty) _bs.getBlock().getStateContainer().getProperty("facing");
					if (_property != null) {
						world.setBlockState(new BlockPos(x + 2, y, z + 1), _bs.with(_property, Direction.NORTH), 3);
					} else {
						world.setBlockState(new BlockPos(x + 2, y, z + 1), _bs.with(
								(EnumProperty<Direction.Axis>) _bs.getBlock().getStateContainer().getProperty("axis"), Direction.NORTH.getAxis()), 3);
					}
				} catch (Exception e) {
				}
				world.setBlockState(new BlockPos(x + 3, y, z + 1), Blocks.AIR.getDefaultState(), 3);
			}
		}
		if ((new Object() {
			public Direction getDirection(BlockPos pos) {
			...
			if (((world.getBlockState(new BlockPos(x - 3, y + 0, z - 1))).getBlock() == DoorMovingAni205Block.block) == true) {
				...
				try {
					...
					DirectionProperty _property = (DirectionProperty) _bs.getBlock().getStateContainer().getProperty("facing");
					if (_property != null) {
						world.setBlockState(new BlockPos(x - 2, y, z - 1), _bs.with(_property, Direction.SOUTH), 3);
					} else {
						world.setBlockState(new BlockPos(x - 2, y, z - 1), _bs.with(
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x + 1, y + 0, z - 3))).getBlock() == DoorMovingAni205Block.block) == true) {
				world.setBlockState(new BlockPos(x + 1, y, z - 2), Closing204Block.block.getDefaultState(), 3);
				try {
					BlockState _bs = world.getBlockState(new BlockPos(x + 1, y, z - 2));
					DirectionProperty _property = (DirectionProperty) _bs.getBlock().getStateContainer().getProperty("facing");
					if (_property != null) {
						world.setBlockState(new BlockPos(x + 1, y, z - 2), _bs.with(_property, Direction.WEST), 3);
					} else {
						world.setBlockState(new BlockPos(x + 1, y, z - 2), _bs.with(
								(EnumProperty<Direction.Axis>) _bs.getBlock().getStateContainer().getProperty("axis"), Direction.WEST.getAxis()), 3);
					}
				} catch (Exception e) {
				}
				world.setBlockState(new BlockPos(x + 1, y, z - 3), Blocks.AIR.getDefaultState(), 3);
			}
		}
		if ((new Object() {
			public Direction getDirection(BlockPos pos) {
			...
			if (((world.getBlockState(new BlockPos(x - 1, y + 0, z + 3))).getBlock() == DoorMovingAni205Block.block) == true) {
				...
				try {
					...
					DirectionProperty _property = (DirectionProperty) _bs.getBlock().getStateContainer().getProperty("facing");
					if (_property != null) {
						world.setBlockState(new BlockPos(x - 1, y, z + 2), _bs.with(_property, Direction.EAST), 3);
					} else {
						world.setBlockState(new BlockPos(x - 1, y, z + 2), _bs.with(

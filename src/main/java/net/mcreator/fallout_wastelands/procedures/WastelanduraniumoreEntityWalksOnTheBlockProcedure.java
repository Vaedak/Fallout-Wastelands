...
public class WastelanduraniumoreEntityWalksOnTheBlockProcedure extends FalloutWastelandsModElements.ModElement {
	public WastelanduraniumoreEntityWalksOnTheBlockProcedure(FalloutWastelandsModElements instance) {
		super(instance, 457);
	}

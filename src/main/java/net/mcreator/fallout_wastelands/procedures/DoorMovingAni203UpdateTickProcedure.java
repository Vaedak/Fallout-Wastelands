...
public class DoorMovingAni203UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public DoorMovingAni203UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1057);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == DoorMovingAni203Block.block.getDefaultState().getBlock())) {
			new Object() {
				private int ticks = 0;
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) (x + 1), (int) y, (int) z), DoorMovingAni204Block.block.getDefaultState(), 3);
				try {
			...
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)), DoorMovingAni204Block.block.getDefaultState(), 3);
				try {

...
public class Closing124UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing124Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), Closing123Block.block.getDefaultState(), 3);
				try {

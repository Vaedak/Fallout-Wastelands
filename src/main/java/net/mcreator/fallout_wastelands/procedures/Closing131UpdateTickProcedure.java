...
public class Closing131UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing131UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1237);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing131Block.block.getDefaultState().getBlock())) {
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Closing130Block.block.getDefaultState(), 3);
				try {

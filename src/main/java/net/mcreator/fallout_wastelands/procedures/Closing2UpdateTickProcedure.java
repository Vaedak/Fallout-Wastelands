...
public class Closing2UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing2Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), CLOSING1AHHHHHHHHHHHBlock.block.getDefaultState(), 3);
				try {

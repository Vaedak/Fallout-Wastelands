...
public class Dooranimation152UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Dooranimation152UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1000);
	}

...
public class Closing203UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing203Block.block) == true) {
				world.setBlockState(new BlockPos(x - 1, y, z), Closing202Block.block.getDefaultState(), 3);
				try {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing203Block.block) == true) {
				world.setBlockState(new BlockPos(x, y, z + 1), Closing202Block.block.getDefaultState(), 3);
				try {

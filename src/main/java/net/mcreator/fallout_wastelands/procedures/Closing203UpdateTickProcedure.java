...
public class Closing203UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing203UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1066);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing203Block.block.getDefaultState()
					.getBlock()) == (true))) {

...
public class Closing204UpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z))).getBlock() == FalloutWastelandsModBlocks.CLOSING_204.get()) == true) {
				world.setBlock(new BlockPos(x, y, z), FalloutWastelandsModBlocks.CLOSING_203.get().defaultBlockState(), 3);
				{

...
public class Closing204UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new Object() {
			...
			if (((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing204Block.block) == true) {
				world.setBlockState(new BlockPos(x, y, z), Closing203Block.block.getDefaultState(), 3);
				try {

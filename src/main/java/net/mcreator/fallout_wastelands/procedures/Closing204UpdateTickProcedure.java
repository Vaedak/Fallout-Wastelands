...
public class Closing204UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing204UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1063);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency x for procedure Closing204UpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency y for procedure Closing204UpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency z for procedure Closing204UpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency world for procedure Closing204UpdateTick!");
			return;
		}
		...
		if (((new Object() {
			...
			if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing204Block.block.getDefaultState()
					.getBlock()) == (true))) {
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Closing203Block.block.getDefaultState(), 3);
				try {

...
public class UraniumblockEntityCollidesInTheBlockProcedure extends FalloutWastelandsModElements.ModElement {
	public UraniumblockEntityCollidesInTheBlockProcedure(FalloutWastelandsModElements instance) {
		super(instance, 454);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency entity for procedure UraniumblockEntityCollidesInTheBlock!");
			return;
		}

...
public class Closing91UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing91UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1279);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency x for procedure Closing91UpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency y for procedure Closing91UpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency z for procedure Closing91UpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				FalloutWastelandsMod.LOGGER.warn("Failed to load dependency world for procedure Closing91UpdateTick!");
			return;
		}
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing91Block.block.getDefaultState().getBlock())) {
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Closing90Block.block.getDefaultState(), 3);
				try {

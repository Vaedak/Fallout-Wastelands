...
public class Closing134UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing134Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), Closing133Block.block.getDefaultState(), 3);
				try {

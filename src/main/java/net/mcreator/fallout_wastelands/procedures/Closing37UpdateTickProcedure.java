...
public class Closing37UpdateTickProcedure extends FalloutWastelandsModElements.ModElement {
	public Closing37UpdateTickProcedure(FalloutWastelandsModElements instance) {
		super(instance, 1333);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Closing37Block.block.getDefaultState().getBlock())) {
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Closing36Block.block.getDefaultState(), 3);
				try {

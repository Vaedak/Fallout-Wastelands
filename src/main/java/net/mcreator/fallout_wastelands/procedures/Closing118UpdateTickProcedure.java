...
public class Closing118UpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Closing118Block.block) {
			if ((new Object() {
				...
				world.setBlockState(new BlockPos(x, y, z), Closing117Block.block.getDefaultState(), 3);
				try {

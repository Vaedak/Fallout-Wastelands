...
import net.mcreator.fallout_wastelands.network.Work1BButtonMessage;
...
public class Work1BScreen extends AbstractContainerScreen<Work1BMenu> {
	private final static HashMap<String, Object> guistate = Work1BMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public Work1BScreen(Work1BMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "raiders found some sort of military vault", -11, 79, -10040320);
		this.font.draw(poseStack, "of course they raided it and found", -11, 88, -10040320);
		...
		this.font.draw(poseStack, "a ton of electronic cards in it", -11, 97, -10040320);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 222, this.topPos + 124, 30, 20, Component.literal("."), e -> {
			if (true) {
				FalloutWastelandsMod.PACKET_HANDLER.sendToServer(new Work1BButtonMessage(0, x, y, z));
				Work1BButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 159, this.topPos + 124, 30, 20, Component.literal("."), e -> {
			if (true) {
				FalloutWastelandsMod.PACKET_HANDLER.sendToServer(new Work1BButtonMessage(1, x, y, z));
				Work1BButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 177, this.topPos + 88, 30, 20, Component.literal("."), e -> {
			if (true) {
				FalloutWastelandsMod.PACKET_HANDLER.sendToServer(new Work1BButtonMessage(4, x, y, z));
				Work1BButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}));
	}
}

...
public class FriendlybrainbotRenderer extends HumanoidMobRenderer<FriendlybrainbotEntity, HumanoidModel<FriendlybrainbotEntity>> {
	public FriendlybrainbotRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public ResourceLocation getTextureLocation(FriendlybrainbotEntity entity) {

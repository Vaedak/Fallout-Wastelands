...
public class TurretShakeActivatorMobEffect extends MobEffect {
	public TurretShakeActivatorMobEffect() {
		super(MobEffectCategory.NEUTRAL, -1);
	}

	@Override
	public String getDescriptionId() {
		return "effect.fallout_wastelands.turret_shake_activator";
	}
